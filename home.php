        ...
        <div class="container main-section">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
                    <div class="row">
                        <!-- getting the user information who is logged -->
                        <?php
                        ...
                        $user_name=$row['user_name'];
                         ...
                         <!-- gatting the user data on which user click -->
                         <?php
                    ...
                    <div class="row">
                        <div id="scrolling_to_bottom" class="col-md-12 right-header-contentChat">
                            <?php
                             ...
                             $sel_msg="select * from users_chat where (sender_username='$user_name' AND
                             receiver_username='$username') OR (receiver_username='$user_name' AND sender_username='$username') ORDER by 1 ASC";
